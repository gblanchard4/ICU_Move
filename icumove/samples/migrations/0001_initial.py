    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('airflow', models.IntegerField(verbose_name=b'Airflow', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('airdirection', models.CharField(max_length=2, verbose_name=b'Air Direction')),
                ('day', models.CharField(default=b'00', max_length=2)),
                ('uid', models.CharField(max_length=16, unique=True, serialize=False, primary_key=True)),
            ],
        ),
